...
async def generate_links(argo_domain):
    ...
    time.sleep(2)
    VMESS = {"v": "2", "ps": f"{NAME}-{ISP}", "add": CFIP, "port": CFPORT, "id": UUID, "aid": "0", "scy": "none", "net": "ws", "type": "none", "host": PROJECT_URL, "path": "/vmess-argo?ed=2560", "tls": "tls", "sni": PROJECT_URL, "alpn": "", "fp": "chrome"}
	
    list_txt = f"""
vless://{UUID}@{CFIP}:{CFPORT}?encryption=none&security=tls&sni={PROJECT_URL}&fp=chrome&type=ws&host={PROJECT_URL}&path=%2Fvless-argo%3Fed%3D2560#{NAME}-{ISP}

vmess://{ base64.b64encode(json.dumps(VMESS).encode('utf-8')).decode('utf-8')}

trojan://{UUID}@{CFIP}:{CFPORT}?security=tls&sni={PROJECT_URL}&fp=chrome&type=ws&host={PROJECT_URL}&path=%2Ftrojan-argo%3Fed%3D2560#{NAME}-{ISP}
    """
